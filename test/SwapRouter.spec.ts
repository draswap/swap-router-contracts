...
import { abi as PAIR_V2_ABI } from '@draswap/v2-core/build/DraswapV2Pair.json'
import { Fixture } from 'ethereum-waffle'
import { BigNumber, constants, Contract, ContractTransaction, Wallet } from 'ethers'
import { solidityPack } from 'ethers/lib/utils'
import { ethers, waffle } from 'hardhat'
import { IDraswapV2Pair, IWETH9, MockTimeSwapRouter02, MixedRouteQuoterV1, TestERC20 } from '../typechain'
...
describe('SwapRouter', function () {
  ...
  async function createV2Pool(tokenA: TestERC20, tokenB: TestERC20): Promise<IDraswapV2Pair> {
    await factoryV2.createPair(tokenA.address, tokenB.address)

    const pairAddress = await factoryV2.getPair(tokenA.address, tokenB.address)
    const pair = new ethers.Contract(pairAddress, PAIR_V2_ABI, wallet) as IDraswapV2Pair
  ...
  describe('swaps - v2', () => {
    let pairs: IDraswapV2Pair[]
    let wethPairs: IDraswapV2Pair[]
