...
import { abi as IDraswapV3PoolABI } from '@draswap/v3-core/artifacts/contracts/interfaces/IDraswapV3Pool.sol/IDraswapV3Pool.json'
import { Fixture } from 'ethereum-waffle'
import { BigNumber, constants, ContractTransaction, Wallet } from 'ethers'
import { solidityPack } from 'ethers/lib/utils'
import { ethers, waffle } from 'hardhat'
import { IDraswapV3Pool, IWETH9, MockTimeSwapRouter02, TestERC20 } from '../typechain'
...
describe('SwapRouter gas tests', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    pools: [IDraswapV3Pool, IDraswapV3Pool, IDraswapV3Pool]
    ...
    const pools = poolAddresses.map((poolAddress) => new ethers.Contract(poolAddress, IDraswapV3PoolABI, wallet)) as [
      IDraswapV3Pool,
      IDraswapV3Pool,
      IDraswapV3Pool
    ]
  ...
  let pools: [IDraswapV3Pool, IDraswapV3Pool, IDraswapV3Pool]
  ...
  describe('#exactInput', () => {
    ...
    it('0 -> 1 minimal', async () => {
      const calleeFactory = await ethers.getContractFactory('TestDraswapV3Callee')
