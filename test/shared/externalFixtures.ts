...
import { abi as FACTORY_V2_ABI, bytecode as FACTORY_V2_BYTECODE } from '@draswap/v2-core/build/DraswapV2Factory.json'
...
} from '@draswap/v3-periphery/artifacts/contracts/NonfungiblePositionManager.sol/NonfungiblePositionManager.json'
